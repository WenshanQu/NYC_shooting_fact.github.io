...
![](photo/boxcox.png)
### Regression Results
After the transformation, we fit the multiple linear regrssion model and apply the backward stepwise method to select the best predictors. Below is the regression resuls
